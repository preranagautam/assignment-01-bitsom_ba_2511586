...
FROM       tbl_products p
JOIN       tbl_orders   o ON p.product_id = o.product_id
...
FROM       tbl_sales_reps sr
LEFT JOIN  tbl_orders     o ON sr.sales_rep_id = o.sales_rep_id
...
SELECT
    ...
    p.unit_price
FROM       tbl_products   p
JOIN       tbl_categories cat ON p.category_id = cat.category_id
LEFT JOIN  tbl_orders     o   ON p.product_id  = o.product_id
